...
Route::post('kontak/post', 'App\Http\Controllers\Home@postKontak');
// Route::post('kontak/kirim_email', 'App\Http\Controllers\Home@sendMail')->name('sendMail');
...
// tukar point
Route::get('tukarpoin', 'App\Http\Controllers\Home@tukarPoin');
Route::get('premium/about', 'App\Http\Controllers\Home@premiumAbout');
...
// Artikel
Route::get('publikasi', 'App\Http\Controllers\Artikel@index');
Route::get('publikasi/cari', 'App\Http\Controllers\Artikel@cari');
Route::get('publikasi/read/{par1}', 'App\Http\Controllers\Artikel@read');
Route::get('publikasi/kategori/{par1}', 'App\Http\Controllers\Artikel@kategori');
// Blog
...
Route::group(['prefix' => 'admin'], function(){
    Route::get('sipindo', 'App\Http\Controllers\Admin\Homepage@sipindo');

    Route::get('main-background', 'App\Http\Controllers\Admin\Homepage@mainBackground');
    Route::patch('main-background/edit', 'App\Http\Controllers\Admin\Homepage@updateMainBackground');
    
    Route::get('kegiatan', 'App\Http\Controllers\Admin\Kegiatan@index');
    Route::post('kegiatan/tambah', 'App\Http\Controllers\Admin\Kegiatan@tambah');
    Route::patch('kegiatan/edit', 'App\Http\Controllers\Admin\Kegiatan@edit');
    Route::get('kegiatan/delete/{par1}', 'App\Http\Controllers\Admin\Kegiatan@delete');
    Route::get('kegiatan/cari', 'App\Http\Controller\Admin\Kegiatan@cari');

    Route::get('fitur', 'App\Http\Controllers\Admin\Fitur@index');
    Route::post('fitur/tambah', 'App\Http\Controllers\Admin\Fitur@tambah');
    Route::patch('fitur/edit', 'App\Http\Controllers\Admin\Fitur@edit');
    Route::get('fitur/delete/{par1}', 'App\Http\Controllers\Admin\Fitur@delete');
    Route::get('fitur/cari', 'App\Http\Controller\Admin\Fitur@cari');
});
// user
...
Route::get('admin/message/delete/{id}', 'App\Http\Controllers\Admin\MessageController@delete');
...
Route::get('admin/artikel/delete/{par1}', 'App\Http\Controllers\Admin\Artikel@delete');
...
Route::get('admin/artikel/upload_font', 'App\Http\Controllers\Admin\Artikel@uploadFont')->name('uploadFont');
Route::post('admin/artikel/upload_font', 'App\Http\Controllers\Admin\Artikel@saveFont')->name('saveFont');
