   ...
   <div class="container pt3">
      <div class="row">
         ...
         <div class="col-md-3">
            <div class="footer-widget">
               ...
               <div class="footer-social">
                  <a href='{{ $site_config->link_googleplay }}' target="_blank" rel="nofollow">
                     <img src="{{ url('uploads/image/play_badge_web_generic.png') }}" class="img-fluid" width="200" alt="Download SIPINDO on Google Play">
                  </a>
                  {{-- <a href="#">
                     <img src="{{ asset('assets/template/assets/img/apple-touch-icon.png') }}" alt="" class="img-fluid">   
                  </a>  --}}
               </div>
            </div>
         </div>
         <div class="col-md-3">
            <div class="footer-widget">
               <h3>Mitra Kami</h3>
               <a href="#" target="_blank">http://www.panahmerah.id/</a><br>
               <a href="#" target="_blank" rel="noopener noreferrer">https://www.icco-cooperation.org/</a><br>
               <a href="#" target="_blank">https://www.ipb.ac.id/</a><br>
               <a href="#" target="_blank" rel="noopener noreferrer">https://nelen-schuurmans.nl/</a>
            </div>
         </div>
         <!--Footer Widget End--> 
      </div>
