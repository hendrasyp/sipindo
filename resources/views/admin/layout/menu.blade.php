  ...
  <aside class="main-sidebar sidebar-light-success elevation-4">
    ...
    <a href="{{ url('admin/dasbor') }}" class="brand-link">
      <img src="{{ asset('uploads/image/'.website('icon')) }}"
         ...
         style="opacity: .8">
      <span class="brand-text font-weight-normal">SIPINDO</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column nav-legacy" data-widget="treeview" role="menu" data-accordion="false">
          <!-- DASHBOARD -->
          <li class="nav-header">KHUSUS SIPINDO</li>
          ...
          <li class="nav-item" id="menuHomepage">
            <a href="#" class="nav-link" id="HomepageNav">
              <i class="nav-icon fas fa-store"></i>
              <p>Homepage <i class="fas fa-angle-left right"></i></p>
            </a>
            <ul class="nav nav-treeview">
              <li id="ProfilSip" class="nav-item">
                <a href="{{ url('admin/main-background') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Main Background</p>
                </a>
              </li>
              <li id="LayananSip" class="nav-item">
                <a href="{{ url('admin/sipindo') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Sipindo</p>
                </a>
              </li>
              <li id="FaqSip" class="nav-item">
                <a href="{{ url('admin/kegiatan') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Kegiatan Kami</p>
                </a>
              </li>
              <li id="DataStaff" class="nav-item">
          ...
          {{-- <li class="nav-item" id="solusiKami">
            <a href="#" class="nav-link">
              <i class="nav-icon fas fa-store"></i>
              <p>
                Solusi Kami
          ...
          <li class="nav-item" id="publikasi">
          ...
          {{-- <li class="nav-item" id="kontakKami">
            <a href="#" class="nav-link">
              <i class="nav-icon fas fa-store"></i>
              <p>
                Kontak Kami
          ...
          {{-- <li class="nav-item" id="mainSipindo">
            <a href="#" class="nav-link" id="SipindoNav">
              <i class="nav-icon fas fa-store"></i>
              <p>Profil SIPINDO <i class="fas fa-angle-left right"></i></p>
            </a>
            <ul class="nav nav-treeview">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      ...
      <div class="row mb-0 mt-2">
          <div class="col-sm-6">
            <h1>SIPINDO Powered By SMARTseeds</h1>
          </div>
          <div class="col-sm-6">
