...
<input type="hidden" name="gambar2" value="{{ $artikel->gambar }}">
</div>
...
<input type="hidden" name="keywords2" value="{{ $artikel->keywords }}">
</div>
</div>
...
<div class="row form-group">
  ...
  <ul class="nav nav-tabs" id="myTab" role="tablist">
    ...
    <input type="hidden" name="isi2" value="{{ $artikel->isi }}">
    </div>
    ...
    <input type="hidden" name="isi_en2" value="{{ $artikel->isi_en }}">
    </div>
    </div>
