<div class="row mb-3">
  ...
  <!-- <a href="{{route('uploadFont')}}" class="btn btn-primary">
            <i class="fa fa-plus"></i> Upload Font Judul
  </a> -->
</div>
<div class="col-md-6">
...
<tr>
    ...
    <?php $site   = DB::table('konfigurasi')->first(); if($artikel->gambar!="") { ?>
      ...
      <img src="{{ asset('uploads/image/artikel/'.$artikel->gambar) }}" class="img-thumbnail img-fluid" >
        </a>
    ...
    <?php echo $artikel->jenis_artikel ?>
    </a>
