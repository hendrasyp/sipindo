...
class Artikel extends Controller
{
    ...
    public function index(Request $request)
    {
		...
		$artikel = $model->list_artikel();
        $editorial = $model->list_editorial();
        $rilis = $model->list_rilis();
        if($request->ajax()){
            return response()->json([
                'artikel' => view('artikel/data-artikel', compact('artikel'))->render(),
                'editorial' => view('artikel/data-editorial', compact('editorial'))->render(),
                'rilis' => view('artikel/data-rilis', compact('rilis'))->render()
            ]);
        }
