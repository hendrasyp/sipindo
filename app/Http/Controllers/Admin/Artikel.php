...
class Artikel extends Controller
{
    ...
    public function uploadFont()
    {
        ...
        $data = array(  'title'       => 'Upload Font',
        'breadcrumb' => 'Artikel',
						'artikel'      => $artikel,
                        'artikels'      => $artikel,
						'kategori'    => $kategori,
                        'font' => $font,
                        'content'     => 'admin/artikel/tambahfont'
                    );
        return view('admin/layout/wrapper',$data);
    }
    ...
    public function tambah_proses(Request $request)
    {
        ...
        if ($request->hasFile('gambar')) {
            ...
            $request->file('gambar')->move("public/uploads/image/artikel", $name);
            $gambar = $name;
        } else {
            $gambar = '';
        }
    ...
    public function edit_proses(Request $request)
    {
        ...
        if ($request->hasFile('gambar')) {
            $file = $request->file('gambar');
            $name = $file->getClientOriginalName();
            $request->file('gambar')->move("uploads/image/artikel", $name);
            $gambar = $name;
        } else {
    ...
    public function saveFont(Request $request){
        ...
        $savedDB = explode(".", $savedname);
        $save = $file->move('uploads/file/fonts', $savedname);
        ...
        if($save){
            ...
            DB::table('fonts')->insert($data);
        }

        return redirect()->previous()->with(['sukses' => 'Font telah di upload']);
    }
}
